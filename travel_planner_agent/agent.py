...
travel_planner_agent = LlmAgent(
    ...
    - *IMPORTANT**: Always confirm the travel dates and the country of origin with the user before proceeding
    ...
    **IMPORTANT**: In the itinerary, you MUST choose only the best options for flights, both arrival and departure. Other available options can be mentioned later as alternatives.
